...
def print_csv(sortedbyfrequency):
    output = open("topwords.csv",'w')
    csvwriter = csv.writer(output)
    for word in sortedbyfrequency[:20]:
        csvwriter.writerow([word, wordcount[word]])
